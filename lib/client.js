...
function installStyles(css2, id2) {
  if (typeof document === "undefined") return function() {
  };
  const fullId = "@dsh-omnifile/styles/" + id2;
...
function installFileIntake(ctx, controller) {
  ctx.effect(() => installStyles(css$3, "file-intake"), "dsh-omnifile: file-intake styles");
...
function installChatCard(ctx, controller) {
  ctx.effect(() => installStyles(css$2, "chat-card"), "dsh-omnifile: chat-card styles");
...
function installNavigation(ctx) {
  ctx.effect(() => installStyles(css$1, "navigation"), "dsh-omnifile: navigation styles");
