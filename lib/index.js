...
function registerFileIntake(ctx, getConfig) {
...
function registerFileParsing(ctx, getConfig) {
  const webServer = ctx.get("webServer");
  if (webServer === void 0) return;
  ctx.effect(() => webServer.register({
    kind: "exact",
...
function registerVision(ctx, _getConfig) {
  const webServer = ctx.get("webServer");
  if (webServer === void 0) return;
  ctx.effect(() => webServer.register({
    kind: "exact",
...
function registerChatCard(ctx, _getConfig) {
  const webServer = ctx.get("webServer");
  if (webServer === void 0) return;
  ctx.effect(() => webServer.register({
    kind: "exact",
...
function registerSettings(ctx, getConfig) {
  const webServer = ctx.get("webServer");
  if (webServer === void 0) return;
  ctx.effect(() => webServer.register({
    kind: "exact",
...
function registerCommonJsRoute(ctx) {
  const webServer = ctx.get("webServer");
  if (webServer === void 0) return;
  ctx.effect(() => webServer.register({
    kind: "exact",
