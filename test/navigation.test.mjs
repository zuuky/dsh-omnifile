/**
 * dsh-omnifile 会话内消息导航（navigation）功能块回归测试（node:test）
 * 运行：node --test test/navigation.test.mjs
 *
 ...
 * 实现位于 features/navigation/client/nav.ts（本文件自带 DOM 桩，自包含）。
 */
...
/* ============ 6. 行为：hover 门控（默认穿透，激活后 pointer-events:auto） ============ */
